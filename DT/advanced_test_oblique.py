...
parser.add_argument(
    ...
    default=None,
    type=str,
    help="This string must contain the range of constants for each variable in the format '#min_0,max_0,step_0,divisor_0;...;min_n,max_n,step_n,divisor_n'. All the numbers must be integers. The min and the max of this range (for each variable) are used to normalize the variables.",
)
...
if __name__ == "__main__":
    ...
    with parallel_backend("multiprocessing"):
        pop, log, hof, best_leaves = eval(args.algorithm)(
            fit_fcn,
            inputs=input_space_size,
            leaf=EpsilonDecayLeaf,
