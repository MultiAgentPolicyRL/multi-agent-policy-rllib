...
if __name__ == "__main__":
    ...
    ray.init()
    policies, policies_to_train, policy_mapping_fn, logger_creator = get_policy_configs(1)
    ...
    algo = PPOTrainer(env="ai-economist", config=dict(connector_config, **{"sample_batch_size": 1000,
